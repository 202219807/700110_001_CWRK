...
public:
	...
	void Render(const Projectile*) const;
	void Render(const std::unique_ptr<Projectile> pProjectile) const;
	void Render(const Tile*) const;
	void Render(const Camera*) const;
	
	// void Render(const std::vector<Agent*> pTeam) const;
};